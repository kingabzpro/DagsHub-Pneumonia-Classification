from ..const.evaluation_const import RAW_VAL_PATH, PROD_MODEL_PATH, PRED_PATH, HISTORY_PARAM_PATH, \
    CHECKPOINT_PATH, DEL_CHECKPOINT, DH_LOG_MET_PATH, DH_LOG_PARAM_PATH
from src.const.general_const import NOTEBOOK, IMG_SIZE, CLASS_NAME_PATH, CLASS_MODE, BATCH_SIZE
...
if __name__ == '__main__':
    # Load dataset
    test_dataset = load_dataset(RAW_VAL_PATH, BATCH_SIZE, IMG_SIZE, CLASS_MODE)
